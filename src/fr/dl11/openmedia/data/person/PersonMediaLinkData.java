...
/**
 * Represents a link between a person and media.
 *
 * <p>The {@code PersonMediaLinkData} class is used to store and retrieve information
 * about the relationship between a person and media, including the origin, equality type,
 * value, and target. The fields are bound to specific keys in a data source using the
 * {@link BindToKey} annotation.
 */
public class PersonMediaLinkData {
    ...
    /**
     * Returns a string representation of the {@code PersonMediaLinkData} object.
     *
